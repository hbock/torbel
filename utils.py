...
def config_check(config):
    ...
    def check_type(var, t, func = None, errmsg = None):
    ...
    for var in ["tor_port", "control_port", "stale_router_timeout", "max_built_circuits"]:
        check_type(var, int, lambda x: x > 0, "Expected positive integer.")
    ...
    check_type("max_pending_factor", float)
    ...
    for var in ["log_level", "torctl_log_level"]:
        check_type(var, type(logger.DEBUG),
